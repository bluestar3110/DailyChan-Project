		...
		<div class="contentsWrap">
			...
			<div class="content oasisLoginHt">
				...
				<div class="oasisLoginWrap oasisJoinWrap">
				 	<div class="newJoinTitle">비밀번호 재발급</div>           
                	  <div class="newJoinSubTitle">
                    	회원님의 소중한 개인정보 보호를 위하여 본인확인이 필요합니다. <br />
						회원가입시 등록한  휴대전화 번호와 입력한 휴대전화 번호가 같아야 인증번호를 받을 수 있습니다. <br />
						발급되는 임시 비밀번호는 단 한번만 사용 할 수 있기 때문에 로그인 후 꼭 비밀번호를 변경해 주세요. 
                     </div>      
					...
					<div class="oasisLoginBtn2">
						<a href="/login" id="btnLogin" style="display:none">로그인하기</a>
						<a href="#"  onclick="findPassword(); return false;" id="btnFindPwd">비밀번호 재발급</a>
					</div>
				</div>
				<!-- //내용 입니다 -->
			</div>
