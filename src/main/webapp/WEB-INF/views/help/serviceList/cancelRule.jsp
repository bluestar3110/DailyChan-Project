                                 ...
                                 <li class="on">
                                        <a href="/dailychan/deliveryRule.action">이용안내</a>
                                            ...
                                            <ul>
                                                ...
                                                <li  class="on"><a href="/dailychan/cancelRule.action">취소/교환/반품</a></li>
...
<!--// 서브 카테고리 -->
    <div id="tab_cnt_area">
        ...
        <!-- 가능기간 -->
                ...
                <div class="info_boxs">
                    <table>
                        ...
                        <tbody>
                            <tr>
                                <td>
                                <span>상품 수령일로부터 7일 이내에 이내에 가능합니다.</span>
                                <p>- 채소/과일류, 냉장/냉동식품, 베이커리 제품, 유제품, 양곡 등은 상품 수령일로부터 다음날까지(영업일 기준) 접수해 주세요.</br>
            ...
            <!--// 가능기간 -->
            <!-- 환불방법 -->   
             <div class="info_txt" style="padding-bottom: 0; padding-top:50px">
                <h4>교환, 반품, 환불 방법</h4>
            </div>
                <div class="info_boxs">
                    <table>
                        ...
                        <tbody>
                            <tr>
                                <td>
                                <span>마이페이지 > 주문관리 선택 후 해당 주문내역에서 1:1 상담신청</span> 버튼을 클릭합니다.</br>
                                <p>1:1 상담 신청 페이지에서 문의 분야를 취소/교환/반품 선택 후 내용을 작성해주세요.</br>
                                상품 하자시 사진 첨부를 꼭 해주세요.</p>
                                </td>
                            </tr>
                        </tbody>
                    </table>
            ...
            <!--// 환불가능 -->
            <!-- 환불불가 -->   
            <div class="info_txt" style="padding-top:50px;padding-bottom:0px">
            ...
            <!--// 환불불가-->
            <!-- 상품품절 -->   
            <div class="info_txt" style="padding-bottom:0px;padding-top:50px;">
                <h4>상품 품절 시 보상 정책</h4>
            </div>
                <div class="info_boxs">
                    <table>
                        ...
                        <tbody>
                            <tr>
                                <td>
                                <span>포인트 5% 추가 보상 환불 제도</span></br>
                                - 구매 후 품절로 인하여 카드 취소/환불/입금 등이 필요한 경우, </br>
                                &nbsp;&nbsp;&nbsp;고객님의 불편을 최소화 하기 위해 결제 금액의 5%를 포인트로 보상해 드리고 있습니다.</br>
                                - 적립 추가 5%+환불 금액은 마이페이지에서 확인 가능합니다.</br>
                                - 포인트 보상 대신 결제 부분 취소를 원하시는 경우</br>
                                &nbsp;&nbsp;&nbsp;1:1 고객센터에 메모 남겨주시면 24시간 이내에 취소가 가능합니다.</br>
                                </td>
                            </tr>
                        </tbody>
                    </table>
