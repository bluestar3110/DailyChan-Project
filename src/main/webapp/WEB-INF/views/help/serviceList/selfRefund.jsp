                                 ...
                                 <li class="on">
                                        <a href="/dailychan/deliveryRule.action">이용안내</a>
                                            ...
                                            <ul>
                                                ...
                                                <li class="on"><a href="/dailychan/selfRefund.action">Self환불서비스</a></li>
    ...
    <div id="tab_cnt_area">
        ...
        <!-- 바로가기 -->
            <div class="info_selfbox">
                ...
                <div style="text-align:center"><a href="/myPage/refundProductList" style="text-algin:center"><div class="info_btn" style="padding:5px 15px">Self환불기 바로가기 </div></a></div>
            </div>
            ...
            <!-- 환불방법 -->   
             <div class="info_txt" style="padding-top:50px">
                ...
                <p>오아시스는 불만족 상품에 대한 반품과 환불이 용이하도록 Self 환불 서비스를 제공하고 있습니다. </br>
                    구매하신 상품의 불만족 시 아래 규정을 먼저 확인해주세요.</p>
            </div>
                <div class="info_boxs">
                    <table>
                        <colgroup>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                배송완료부터 1주일 이내 환불 요청이 가능합니다.</br>
                                환불 요청 후 담당자의 검토/승인 까지 최대 하루 정도 소요됩니다.(영업일 기준)
                            ...
                            <tr>
                                ...
                                <td>
                                1. 마이페이지에서 환불서비스를 선택합니다.</br>
                                2. 환불가능상품 리스트에서 환불해당 상품에 환불요청을 클릭합니다.</br>
                                &nbsp;&nbsp;&nbsp; 환불가능상품은 상품의 배송완료 일자가 1주일 이내인 상품에 대해 가능합니다.</br>
                                3. 환불유형선택 후 상품 하자일 경우 환불액을 직접 선택할 수 있습니다.</br>
                                &nbsp;&nbsp;&nbsp; 상품하자의 경우 사진 첨부 후 환불 요청을 해주세요.</br>
                            &nbsp;&nbsp;&nbsp; 상품 미수령일 경우 상품구매가격의 100%를 포인트로 환불해 드립니다.</br>
                                4. 최종환불은 최대 하루 정도 소요됩니다.</br>
                            &nbsp;&nbsp;&nbsp; 사실과 다른 환불 요청의 경우 반려처리 될 수 있습니다.</br>
                                </td>
                            </tr>
                            <tr>
                                <th>
                                ...
                                <td>
                                환불 요청 시 포인트로 지급됩니다.</br>
                                결제수단으로 환불을 원하실 경우 고객센터로 연락주시기 바랍니다.</br>
                                </td>
                            </tr>                                               
                        </tbody>
                    </table>
                    <div style="padding:10px 0 0 20px">*보다 자세한 Self환불기 이용방법이 궁금하시면 환불기 이용안내를 참고 하세요. <a href="/dailychan/selfRefundDetail.action" class="btn">Self환불서비스 안내 바로가기</a></div>
                </div>                  
            <!--// 환불가능 -->
                    ...
                    <div class="help_box_right">
                        <ul>
                            ...
                            <li style=" padding-top: 10px;">
                                ...
                                <div class="help_btn_right"><a href="/dailychan/qnaList.action">상담내역보기</a>
                                </div>
                            </li>
                        </ul>
                    </div> 
